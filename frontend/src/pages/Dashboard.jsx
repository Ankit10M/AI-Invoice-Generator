  ...
  return (
    <div className={dashboardStyles.pageContainer}>
      <div className={dashboardStyles.headerContainer}>
        ...
        <p className={dashboardStyles.headerSubtitle}>Track your invoicing performance an business insights</p>
      </div>
      {/* loading eror */}
      {loading ? (
        ...
        <div className='p-6'>
          ...
          <div className='flex gap-2'>
            <button className='px-3 py-1 bg-blue-600 text-white rounded' onClick={fetchInvoices}>Retry</button>
            {String(error).toLowerCase().includes('unauthorized') && (
              <button className='px-3 py-1 bg-gray-700 text-white rounded' onClick={() => navigate('/login')}>Sign In</button>
            )}
          </div>
        </div>
      ) : null}
      <div className={dashboardStyles.kpiGrid}>
        ...
        <KpiCard title='Total Paid' value={currencyFmt(kpis.totalPaid, "INR")} hint='Recieved Amount (INR)' iconType='revenue' trend={12.5} />
      ...
      <div className={dashboardStyles.mainGrid}>
        <div className={dashboardStyles.sidebarColumn}>
          <div className={dashboardStyles.quickStatsCard}>
            <h3 className={dashboardStyles.quickStatsTitle}>Quick Start</h3>
            <div className='space-y-3'>
              ...
              <div className={dashboardStyles.quickStatsRow}>
                <span className={dashboardStyles.quickStatsValue}>Avg. Invoice</span>
                <span className={dashboardStyles.quickStatsValue}>{currencyFmt(kpis.totalInvoices > 0 ? (kpis.totalPaid + kpis.totalUnpaid) / kpis.totalInvoices : 0, "INR")}</span>
              </div>
              <div className={dashboardStyles.quickStatsRow}>
          ...
          <div className={dashboardStyles.cardContainerOverflow}>
            <div className={dashboardStyles.tableHeader}>
              <div className={dashboardStyles.tableHeaderContent}>
                ...
                <button className={dashboardStyles.tableActionButton} onClick={() => navigate('/app/invoices')}>
                  View All
                  <svg
                    className="w-4 h-4"
                    viewBox="0 0 24 24"
              ...
              <table className={dashboardStyles.table}>
                ...
                <tbody className={dashboardStyles.tableBody}>
                  {recent.map((inv) => {
                    ...
                    return (
                      <tr key={inv.id} className={dashboardStyles.tableRow} onClick={() => openInvoice(inv)}>
                        ...
                        <td className={dashboardStyles.tableCell}>
                          <div className='text-right'><button onClick={(e) => { e.stopPropagation(); openInvoice(inv); }} className={dashboardStyles.actionButton}>
                  ...
                  {recent.length === 0 && !loading && (
                    <tr>
                      <td className={dashboardStyles.emptyState} colSpan='5'>
