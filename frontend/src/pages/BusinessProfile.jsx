...
const BusinessProfile = () => {
    ...
    async function getAuthToken() {
        ...
        try {
            ...
            if (!t) t = await getToken().catch(() => null);
            return t;
        } catch {
            return null;
        }
    ...
    return (
        <div className={businessProfileStyles.pageContainer}>
            <div className={businessProfileStyles.headerContainer}>
                ...
                <p className={businessProfileStyles.headerSubtitle}>Configure your Company Details, Branding assets and Invoice defaults</p>
                {!isSignedIn && (
                    <div style={{ marginTop: 12, color: '#92400e', background: '#fff7ed', padding: 10, borderRadius: 8 }}>
            ...
            <form onSubmit={handleSave} className={businessProfileStyles.pageContainer}>
                <div className={businessProfileStyles.cardContainer}>
                    ...
                    <div className={businessProfileStyles.gridColSpan2}>
                        <div>
                            ...
                            <input className={businessProfileStyles.input} value={meta.businessName || ''} onChange={(e) => updateMeta('businessName', e.target.value)} placeholder='Enter Your Business Name' />
                            <div>
                                <label className={businessProfileStyles.label}>Email</label>
                                <input className={businessProfileStyles.input} value={meta.email || ''} onChange={(e) => updateMeta('email', e.target.value)} placeholder='Enter Your Email' />
                            </div>
                            <div className={businessProfileStyles.gridColSpan2}>
                                <label className={businessProfileStyles.label}>Address</label>
                                <textarea className={businessProfileStyles.textarea} value={meta.address || " "} rows={3} placeholder='Enter Your Business Address' onChange={(e) => updateMeta('address', e.target.value)}></textarea>
                            </div>
                            <div>
                                <label className={businessProfileStyles.label}>Phone</label>
                                <input className={businessProfileStyles.input} value={meta.phone || ""} onChange={(e) => updateMeta('phone', e.target.value)} placeholder='Your Phone Number' />
                            </div>
                            <div>
                                <label className={businessProfileStyles.label}>GST Number</label>
                                <input className={businessProfileStyles.input} value={meta.gst || ""} onChange={(e) => updateMeta('gst', e.target.value)} placeholder='27AAAPL3C123ZC1V' />
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div className={businessProfileStyles.taxContainer}>
                                    ...
                                    <div className='flex items-center gap-3'>
                                        <input type='number' min='0' max='100' step='0.1' className={businessProfileStyles.taxInput} value={meta.defaultTaxPercent ?? 18}
                ...
                <div className={businessProfileStyles.actionContainer}>
                    <div className={businessProfileStyles.actionInnerContainer}>
                        <div className={businessProfileStyles.actionButtonGroup}><button className={businessProfileStyles.saveButton} type='submit' onClick={handleSave} disabled={saving}>
                            <SaveIcon className='w-4 h-4' />{" "}
                            {saving ? "Saving..." : "Save Profile"}
                        </button>
                            <button className={businessProfileStyles.resetButton} type='button' onClick={handleClearProfile}>
