                ...
                <div className={heroStyles.grid}>
                    <div className={heroStyles.content}>
                        <div className={heroStyles.contentInner}>
                            ...
                            <p className={heroStyles.description}>Transform Conversation into professional invoices with AI.{" "}<span className={heroStyles.descriptionHighlight}>Paste any Text</span>{" "}
                                and watch AI extract items, calculate totals, and generate ready-to-send instantly</p>
                        </div>
                        {/* cta button */}
                        <div className={heroStyles.ctaContainer}>
                            <SignedIn>
                                <button type='button' onClick={handleSignedInPrimary} className={heroStyles.primaryButton}>
                                    ...
                                    <span className={heroStyles.previewButtonText}>Start Creating Free</span>
                                    <svg
                        ...
                        <div className={heroStyles.featuresGrid}>
                            {[
                                ...
                                <div className={heroStyles.featureItem} key={index}>
                        ...
                        <div className={heroStyles.demoContainer}>
                            <div className={heroStyles.demoCard}>
                                    ...
                                    <div className='space-y-1'>
                                        <div className={heroStyles.cardLogoContainer}>
                                            ...
                                            <div>
                                                ...
                                                <div className={heroStyles.cardClientGst}>GST: 27AAAPL1234C1ZV</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className={heroStyles.actionButtons}>
                                    ...
                                    <button className={heroStyles.sendButton}><span className={heroStyles.sendButtonText}>Send Invoice</span></button>
                                </div>
                            </div>
                            <div className={heroStyles.aiIndicator}>
                                <div className={heroStyles.aiIndicatorContent}>
                                    ...
                                    <span>AI parsed from: </span><span className={heroStyles.aiIndicatorText}>"Invoice for web design - ₹15,000..."</span></div>
                            </div>
