        ...
        <section className={featuresStyles.section} id='features'>
            ...
            <div className={featuresStyles.container}>
                <div className={featuresStyles.headerContainer}>
                    <div className={featuresStyles.badge}><span className={featuresStyles.badgeDot}></span>
                        <span className={featuresStyles.badgeText}>Powerful Features</span>
                    </div>
                    <h2 className={featuresStyles.title}>Built For{" "}<span className={featuresStyles.titleGradient}>Speed & Clarity</span></h2>
                    <p className={featuresStyles.subtitle}>A minimal, intelligent interface that focuses on what truly matters - create, send, and track invoices effortlessly while maintaining professional excellence</p>
                </div>
                <div className={featuresStyles.featuresGrid}>{features.map((feature, index) => (
                    <FeatureCard key={feature.title} title={feature.title} desc={feature.desc} icon={feature.icon} delay={index * 100} />
                ))}</div>
                {/* bottom cta */}
